...
TransMenu.shadowSize = 4;//2						// size of shadow under menu
TransMenu.shadowOffset = 4;//3						// distance shadow should be offset from leading edge
TransMenu.shadowColor = "#888";						// color of shadow (transparency is set in CSS)
TransMenu.shadowPng = "images/grey-40.png";			// a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#111";					// color of the background (transparency set in CSS)
TransMenu.backgroundPng = "images/white-90.png";	// a PNG graphic to server as the background for mac IE5
TransMenu.hideDelay = 600;//1000					// number of milliseconds to wait before hiding a menu
...
function TransMenu(oActuator, iDirection, iLeft, iTop, iReferencePoint, parentMenuSet) {
        ...
        function initEvents() {
                ...
                if (typeof oActuator.tagName != "undefined") {
                        oActuator.onclick = actuator_mouseover; // mouseover
                        oActuator.onmouseout = actuator_mouseout;
                }

                // hook menu mouseover
                elmCache["content"].onmouseover = content_mouseover; // mouseover
